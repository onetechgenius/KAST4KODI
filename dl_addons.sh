...
cd addons/
wget http://mirrors.xbmc.org/addons/frodo/script.module.t0mm0.common/script.module.t0mm0.common-2.1.1.zip
unzip script.module.t0mm0.common-2.1.1.zip
rm script.module.t0mm0.common-2.1.1.zip
cd ..
